...
### Crie um novo builder multiplataforma:
...
Este comando cria um novo builder chamado "MultiBuilder" e configura o Docker para usá-lo para futuros comandos docker buildx.
...
Agora, cada vez que você quiser aplicar as modificações feitas no seu projeto aos Raspberry Pi e outros dispositivos vinculados, basta executar o comando de build (com --push) novamente. Com isso a imagem será atualizada no Container Registry e o Watchtower nos dispositivos irá conferir e encontar a atualização, e com isso atualizar o container do projeto! **_"Mas não é magia... é tecnologia!"_** rsrsrsrs
